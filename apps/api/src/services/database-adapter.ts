/**
 * Database Adapter - Backwards Compatible Migration Layer
 * 
 * This service:
 * 1. Provides the exact same interface as the old DatabaseService
 * 2. Uses Prisma under the hood
 * 3. Allows gradual migration without breaking existing bot functionality
 * 4. Can be swapped in place of the old service
 */
